...
{
    public class TopPipe : INotifyPropertyChanged
    {
        ...
        public TopPipe(double positionX, double gapPositionY, double gapSize, double width, double speed)
        {
        ...
        public bool IsCollision(double birdX, double birdY, double birdWidth, double birdHeight)
        {
            ...
            // Check collision with the top part of the pipe
            return birdY < GapPositionY;
        }
